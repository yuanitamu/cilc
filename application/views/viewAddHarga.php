        ...
        <div class="span9">
          <div class="box paint color_15">
            <div class="title">
              ...
              <?php if ($detail['sukses']===2){echo '<button type="button" class="btn btn-large btn-block btn-success">Upload sucessful</button>';} 
                    if ($detail['sukses']===3){echo '<button type="button" class="btn btn-large btn-block btn-danger">The image cant be uploaded , please check type and size</button>';} 
                    if ($detail['sukses']===1){echo '<button type="button" class="btn btn-large btn-block btn-danger">Tha data that you type is incorect, please check again</button>';} 
               ?>
            </div>
            <div class="content">
             <?php $attributes = array('class' => 'form-horizontal row-fluid'); echo form_open('admin/AddPrice', $attributes); ?>
            
               <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Food</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="makan" >
               ...
               <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="kereta">
                  </div></div>
                </div>
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="car" >
                  </div></div>
                </div>
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="taxi" >
                  </div></div>
                </div>
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                   <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" >
                  </div></div>
                </div> 
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="hotel" >
                  </div></div>
                </div>                
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="apartment" >
                  </div></div>
                </div>       
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="home" >
                  </div></div>
                </div>  
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="listrik" >
                  </div></div>
                </div>    
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="air" >
                  </div></div>
                </div>    
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="minum" >
                  </div></div>
                </div>    
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="gas" >
                  </div></div>
                </div>      
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="laundry" >
                  </div></div>
                </div>  
