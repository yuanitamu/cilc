  ...
  <div class="viewport ">
    <div class="overview collapse">
      ...
      <ul id="sidebar_menu" class="navbar nav nav-list container full">
        ...
        <li class="accordion-group  color_7 active"> <?php echo anchor('admin/homeAddCountry',' <img src="'.base_url().'assets/metrostyle/img/menu_icons/forms.png"><span>Add Country</span>'); ?> </li>
      ...
      <h2>Add Country</h2>
        ...
        <div class="span9">
          <div class="box paint color_7">
            ...
            <div class="content">
             <?php $attributes = array('class' => 'form-horizontal row-fluid'); echo form_open_multipart('admin/AddCountry', $attributes); ?>
               <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Country</label>
                  <div class="controls span7">
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Type the name of country" placeholder="Country's Name" class="row-fluid" name="negara">
                  </div>
                </div>
               <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Capital</label>
                  <div class="controls span7">
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Type the name of capital" placeholder="Capital's Name" class="row-fluid" name="ibukota">
                  </div>
                </div>
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Area (km2)</label>
                  <div class="controls span7">
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the count" placeholder="Area's Count" class="row-fluid" name="luas">
                  </div>
                </div>
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Population (/km2)</label>
                  <div class="controls span7">
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the count" placeholder="Population's Count" class="row-fluid" name="kepadatan">
                  </div>
                </div>
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Currency</label>
                  <div class="controls span7">
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Type kind of currency" placeholder="Kind of mata uang" class="row-fluid" name="matauang">
                  </div>
                </div> 
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Formal Language</label>
                  <div class="controls span7">
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Type kind of language" placeholder="Kind of language" class="row-fluid" name="bahasa">
                  </div>
                </div>                
                <div class="form-row control-group row-fluid">
