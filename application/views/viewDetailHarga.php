        ...
        <div class="span9">
          <div class="box paint color_9">
            <div class="title">
              ...
              <h4> <span><?php echo '<img src="'.base_url().'upload/'.$key->bendera.'" width=100px/>'; ?><?php echo "  ".$key->nama; ?></span> </h4>
