...
<div id="main">
  <div class="container">
    ...
    <div id="main_container">
      <h2>List Price of Each Country</h2>
      <div class="row-fluid">
        <div class="box ">
          <div class="title">
            <h4> <span>Data Price <small>(all of counts will return in json mode)</small></span> </h4>
          </div>
          <!-- End .title -->
            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="">Food</th>
                  <th class="to_hide_phone">Train</th>
                  <th class="to_hide_phone">Car</th>
                  <th class="to_hide_phone">Taxi</th>
                  <th class="to_hide_phone">Buss</th>
                  <th class="to_hide_phone">Hotel</th>
                  <th class="to_hide_phone">Home</th>
                  <th class="to_hide_phone">Water</th>
                  <th class="to_hide_phone no_sort">....</th>
              ...
              <tbody>
                <?php foreach ($detail['negara']->result() as $key ): ?>
                  <tr>
                    <td><img class="thumbnail small" src="<?php echo base_url().'upload/'.$key->bendera ?>"></td>
                    <?php if ($detail['list']['data1'][$key->idNegara]['harga']!=null){ ?>
                      <td class=""><?php echo "$ ".$detail['list']['data1'][$key->idNegara]['harga']['makan']; ?></td>
                      <td class="to_hide_phone"><?php echo "$ ".$detail['list']['data1'][$key->idNegara]['harga']['transKereta']; ?></td>
                      <td class="to_hide_phone"><?php echo "$ ".$detail['list']['data1'][$key->idNegara]['harga']['transPribadi']; ?></td>
                      <td class="to_hide_phone"><?php echo "$ ".$detail['list']['data1'][$key->idNegara]['harga']['transTaxi']; ?></td>
                      <td class="to_hide_phone"><?php echo "$ ".$detail['list']['data1'][$key->idNegara]['harga']['transBus']; ?></td>
                      <td class="to_hide_phone"><?php echo "$ ".$detail['list']['data1'][$key->idNegara]['harga']['hotel']; ?></td>
                      <td class="to_hide_phone"><?php echo "$ ".$detail['list']['data1'][$key->idNegara]['harga']['home']; ?></td>
                      <td class="to_hide_phone"><?php echo "$ ".$detail['list']['data1'][$key->idNegara]['harga']['air']; ?></td>   
                      <td class="to_hide_phone no_sort">.....</td> 
                      <td class="ms no_sort"><div class="btn-group1"> <?php echo anchor('admin/homeUpdatePrice/'.$key->idNegara, '<i class="gicon-edit"></i>', array('class' => 'btn btn-small','rel'=>'tooltip','data-placement'=>'left','data-original-title'=>'Edit')); ?> <?php echo anchor('admin/homeDetailPrice/'.$key->idNegara, '<i class="gicon-eye-open"></i>', array('class' => 'btn btn-small','rel'=>'tooltip','data-placement'=>'top','data-original-title'=>'View')); ?> </div></td>
                    <?php } else  {?>
                      <td class=""><?php echo "$ -"; ?></td>
                      <td class="to_hide_phone"><?php echo "$ -"; ?></td>
                      <td class="to_hide_phone"><?php echo "$ -"; ?></td>
                      <td class="to_hide_phone"><?php echo "$ -"; ?></td>
                      <td class="to_hide_phone"><?php echo "$ -"; ?></td>
                      <td class="to_hide_phone"><?php echo "$ -"; ?></td>
                      ...
                      <td class="to_hide_phone"><?php echo "$ -"; ?></td>  
                      <td class="to_hide_phone no_sort">.....</td> 
                      <td class="ms no_sort"><div class="btn-group1"> <?php echo anchor('admin/homeAddPrice/'.$key->idNegara, '<i class="gicon-edit"></i>', array('class' => 'btn btn-small','rel'=>'tooltip','data-placement'=>'left','data-original-title'=>'Edit')); ?>  </div></td>
                    <?php } ?>
