...
<div id="main">
  <div class="container">
    ...
    <div id="main_container">
      <h2>List Location of Each Country</h2>
      <div class="row-fluid">
        <div class="box ">
          <div class="title">
            <h4> <span>Data Location <small>(all of counts will return in json mode)</small></span> </h4>
          </div>
          <!-- End .title -->
            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="to_hide_phone">Lattitude</th>
              ...
              <tbody>
                ...
                <?php foreach ($detail['negara']->result() as $key ): ?>
                  <tr>
                    ...
                    <?php if ($detail['list']['data1'][$key->idNegara]['map']!=null){ ?>
                      <td><img class="thumbnail small" src="<?php echo base_url().'upload/'.$key->bendera ?>"></td>
                      <td class=""><?php echo $detail['list']['data1'][$key->idNegara]['map']['long']; ?></td>
                      <td class="to_hide_phone"><?php echo $detail['list']['data1'][$key->idNegara]['map']['lat']; ?></td>
                      <td class="ms no_sort"><div class="btn-group1"> <?php echo anchor('admin/homeUpdateMap/'.$key->idNegara, '<i class="gicon-edit"></i>', array('class' => 'btn btn-small','rel'=>'tooltip','data-placement'=>'left','data-original-title'=>'Edit')); ?>  </div></td>
                    <?php } else  {?>
                      <td><img class="thumbnail small" src="<?php echo base_url().'upload/'.$key->bendera ?>"></td>
                      <td class=""><?php echo " -"; ?></td>
                      <td class="to_hide_phone"><?php echo " -"; ?></td>
                      <td class="ms no_sort"><div class="btn-group1"> <?php echo anchor('admin/homeAddMap/'.$key->idNegara, '<i class="gicon-edit"></i>', array('class' => 'btn btn-small','rel'=>'tooltip','data-placement'=>'left','data-original-title'=>'Edit')); ?>  </div></td>
                    <?php } ?>
