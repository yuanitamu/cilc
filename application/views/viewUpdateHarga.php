  ...
  <div class="viewport ">
    <div class="overview collapse">
      ...
      <ul id="sidebar_menu" class="navbar nav nav-list container full">
        ...
        <li class="accordion-group  color_13 active"> <?php echo anchor('admin/homeListPrice',' <img src="'.base_url().'assets/metrostyle/img/menu_icons/widgets.png"><span>Price List</span>'); ?> </li>
  ...
  <div class="container">
    ...
    <div id="main_container">
      <h2>Update Price</h2>
        <div class="row-fluid">
        <div class="span9">
          <div class="box paint color_15">
            <div class="title">
              <h4> <i class="icon-book"></i><span>Input Fields</span> </h4>
              <?php if ($detail['sukses']===2){echo '<button type="button" class="btn btn-large btn-block btn-success">Update sucessful</button>';} 
                    if ($detail['sukses']===3){echo '<button type="button" class="btn btn-large btn-block btn-danger">The data cant be updated , please check your input</button>';} 
                    if ($detail['sukses']===1){echo '<button type="button" class="btn btn-large btn-block btn-danger">The data cant be updated , please check your input</button>';} 
               ?>
            </div>
            <div class="content">
             <?php $attributes = array('class' => 'form-horizontal row-fluid'); echo form_open('admin/UpdatePrice', $attributes); ?>
             <?php foreach ($detail['negara']->result() as $key ): ?>
               <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Food</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="makan" value="<?php echo $detail['list']['data1'][$key->idNegara]['harga']['makan']; ?>">
                      <span class="add-on prepend ">$</span>
                  </div></div>
                </div>
               <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Train Ticket</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="kereta" value="<?php echo $detail['list']['data1'][$key->idNegara]['harga']['transKereta']; ?>">
                  </div></div>
                </div>
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Private Transportation</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="car" value="<?php echo $detail['list']['data1'][$key->idNegara]['harga']['transPribadi']; ?>">
                  </div></div>
                </div>
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Taxi Ticket</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="taxi" value="<?php echo $detail['list']['data1'][$key->idNegara]['harga']['transTaxi']; ?>">
                  </div></div>
                </div>
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Bus Ticket</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                   <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="bus" value="<?php echo $detail['list']['data1'][$key->idNegara]['harga']['transBus']; ?>">
                  </div></div>
                </div> 
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Hotel Rent</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="hotel" value="<?php echo $detail['list']['data1'][$key->idNegara]['harga']['hotel']; ?>">
                  </div></div>
                </div>                
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Apartment Rent</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="apartment" value="<?php echo $detail['list']['data1'][$key->idNegara]['harga']['apartment']; ?>">
                  </div></div>
                </div>       
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Home Tax</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="home" value="<?php echo $detail['list']['data1'][$key->idNegara]['harga']['home']; ?>">
                  </div></div>
                </div>  
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Electricity</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="listrik" value="<?php echo $detail['list']['data1'][$key->idNegara]['harga']['listrik']; ?>">
                  </div></div>
                </div>    
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Fresh Water</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="air" value="<?php echo $detail['list']['data1'][$key->idNegara]['harga']['air']; ?>">
                  </div></div>
                </div>    
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Drink Water</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="minum" value="<?php echo $detail['list']['data1'][$key->idNegara]['harga']['airminum']; ?>">
                  </div></div>
                </div>    
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Gass</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="gas" value="<?php echo $detail['list']['data1'][$key->idNegara]['harga']['gas']; ?>">
                  </div></div>
                </div>      
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Laundry</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <span class="add-on prepend ">$</span>
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the nominal" placeholder="count" class="row-fluid" name="laundry" value="<?php echo $detail['list']['data1'][$key->idNegara]['harga']['laundry']; ?>">
                  </div></div>
                </div>    

                <input type="hidden" value="<?php echo $detail['idharga']; ?>" name="id">
