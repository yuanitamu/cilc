  ...
  <div class="viewport ">
    <div class="overview collapse">
      ...
      <ul id="sidebar_menu" class="navbar nav nav-list container full">
        ...
        <li class="accordion-group  color_10 active"> <?php echo anchor('admin/homeListMap',' <img src="'.base_url().'assets/metrostyle/img/menu_icons/maps.png"><span>Country Location</span>'); ?> </li>
      ...
      <h2>List Country</h2>
        ...
        <div class="span12">
          <div class="box paint color_15">
            ...
            <div class="content">
             <?php $attributes = array('class' => 'form-horizontal row-fluid'); echo form_open('admin/UpdateLocation', $attributes); ?>
              <?php foreach ($detail['negara']->result() as $key ): ?>
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Lattitude</label>
                  <div class="controls span5">
                    <input required type="text" id="latz" rel="tooltip" data-placement="top" data-original-title="Insert lattitude" placeholder="count" class="row-fluid" name="lat" value="<?php echo $detail['list']['data1'][$key->idNegara]['map']['lat']; ?>">
                  </div>
                </div>
                <div class="form-row control-group row-fluid">
                   <label class="control-label span3" for="with-tooltip">Longitude</label>
                  <div class="controls span5">                   
                    <input required type="text" id="langz" rel="tooltip" data-placement="top" data-original-title="Insert longitude" placeholder="count" class="row-fluid" name="long" value="<?php echo $detail['list']['data1'][$key->idNegara]['map']['long']; ?>">
                  </div>
                 </div> 
