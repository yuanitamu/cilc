      ...
      <h2>Update Country</h2>
        ...
        <div class="span9">
          <div class="box paint color_7">
            ...
            <div class="content">
             <?php $attributes = array('class' => 'form-horizontal row-fluid'); echo form_open_multipart('admin/UpdateCountry', $attributes); ?>
              <?php foreach ($detail['negara']->result() as $key ): ?>
               <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Country</label>
                  <div class="controls span7">
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Type the name of country" placeholder="Country's Name" class="row-fluid" name="negara" value="<?php echo $key->nama; ?>">
                  </div>
                </div>
               <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Capital</label>
                  <div class="controls span7">
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Type the name of capital" placeholder="Capital's Name" class="row-fluid" name="ibukota"  value="<?php echo $key->ibukota; ?>">
                  </div>
                </div>
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Area (km2)</label>
                  <div class="controls span7">
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the count" placeholder="Area's Count" class="row-fluid" name="luas"  value="<?php echo $key->luas; ?>">
                  </div>
                </div>
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Population (/km2)</label>
                  <div class="controls span7">
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Insert the count" placeholder="Population's Count" class="row-fluid" name="kepadatan"  value="<?php echo $key->kepadatan; ?>">
                  </div>
                </div>
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Currency</label>
                  <div class="controls span7">
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Type kind of currency" placeholder="Kind of mata uang" class="row-fluid" name="matauang"  value="<?php echo $key->matauang; ?>">
                  </div>
                </div> 
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Formal Language</label>
                  <div class="controls span7">
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Type kind of language" placeholder="Kind of language" class="row-fluid" name="bahasa"  value="<?php echo $key->bahasa; ?>">
                  </div>
                </div>                
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="search-input">Flag</label>
                  <div class="controls span7">
                    <div class="input-append row-fluid">
                      <input  required type="file" class="spa1n6 fileinput" id="search-input" name="bendera"  >
                      > </div>
                  </div>
                </div>
                <input type="hidden" name="id" value="<?php echo $key->idNegara; ?>">
                <input type="hidden" name="flags" value="<?php echo $key->bendera; ?>">
