  ...
  <div class="viewport ">
    <div class="overview collapse">
      ...
      <ul id="sidebar_menu" class="navbar nav nav-list container full">
        ...
        <li class="accordion-group  color_19 active"> <?php echo anchor('admin/homeUpdatePassword',' <img src="'.base_url().'assets/metrostyle/img/menu_icons/locker.png"><span>Change Password</span>'); ?> </li>
        ...
        <div class="span9">
          <div class="box paint color_10">
            <div class="title">
              ...
              <?php if ($detail['sukses']===4){echo '<button type="button" class="btn btn-large btn-block btn-success">Update sucessful</button>';} 
                    if ($detail['sukses']===3){echo '<button type="button" class="btn btn-large btn-block btn-danger">Cant be update password</button>';} 
                    if ($detail['sukses']===5){echo '<button type="button" class="btn btn-large btn-block btn-danger">Password that you type is incorect, please check again</button>';} 
               ?>
            </div>
            <div class="content">
             <?php $attributes = array('class' => 'form-horizontal row-fluid'); echo form_open('admin/UpdatePassword', $attributes); ?>
               <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Current Password</label>
                  <div class="controls span7">
                    <input required type="password" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Type your current password" placeholder="Input Password" class="row-fluid" name="curpas" >
                  </div>
                </div>     
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">New Password</label>
                  <div class="controls span7">
                    <input required type="password" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Type your new password" placeholder="Input Password" class="row-fluid" name="newpas" >
                  </div>
                </div>     
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Retype Password</label>
                  <div class="controls span7">
                    <input required type="password" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Retype your new password" placeholder="Input Password" class="row-fluid" name="konfnewpas" >
                  </div>
                </div>  
                <input type="hidden" value=<?php echo $detail['username']; ?> name="user">   
