  ...
  <div class="viewport ">
    <div class="overview collapse">
      ...
      <ul id="sidebar_menu" class="navbar nav nav-list container full">
        ...
        <li class="accordion-group  color_15 active"> <?php echo anchor('admin/homeUpdateUsername',' <img src="'.base_url().'assets/metrostyle/img/menu_icons/profil.png"><span>Update Username</span>'); ?> </li>
          ...
          <div class="box paint color_10">
            <div class="title">
              ...
              <?php if ($detail['sukses']===4){echo '<button type="button" class="btn btn-large btn-block btn-success">Update sucessful</button>';} 
                    if ($detail['sukses']===3){echo '<button type="button" class="btn btn-large btn-block btn-danger">Cant be update username</button>';} 
            ...
            <div class="content">
             <?php $attributes = array('class' => 'form-horizontal row-fluid'); echo form_open('admin/UpdateUsername', $attributes); ?>
               <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">New Username</label>
                  <div class="controls span7">
                    <input required type="text" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Type your new username" placeholder="Input Username" class="row-fluid" name="useredit" >
                  </div>
                </div>     
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Password</label>
                  <div class="controls span7">
                    <input required type="password" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="Type your  password" placeholder="Input Password" class="row-fluid" name="password" >
                  </div>
                </div>            
